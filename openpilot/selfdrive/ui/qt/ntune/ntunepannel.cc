...
nTuneMainWidget::nTuneMainWidget(QWidget *parent)
    ...
    mainItems = {
    {
        ...
        TuneItemInfo(NTUNE_FILES["common"], "pathOffset",
                 tr("Path Offset (Left / Right)"),
                 0.00f, -0.10f, 0.10f, 0.01f, 2),
        TuneItemInfo(NTUNE_FILES["common"], "steerActuatorDelay", tr("Steer Actuator Delay"),
             0.2f, 0.0f, 0.8f, 0.01f, 2, "sec"),
        TuneItemInfo(NTUNE_FILES["common"], "steerRatio", tr("Steer Ratio"),
             17.0f, 10.0f, 25.0f, 0.1f, 1),
    },
    {
