...
class CAR:
  ...
  IONIQ_EV_AE_2020 = "HYUNDAI 2020 IONIQ ELECTRIC (AE)"
...
CAR_INFO: Dict[str, Union[HyundaiCarInfo, List[HyundaiCarInfo]]] = {
  ...
  CAR.K9_RJ: HyundaiCarInfo("Kia K9 2019"),
...
CHECKSUM = {
  "crc8": [CAR.SANTAFE_TM, CAR.SANTAFE_TM_2022, CAR.SONATA_DN8, CAR.PALISADE_LX2, CAR.SONATA_HEV_DN8, CAR.SELTOS_SP2, CAR.AVANTE_CN7, CAR.SOUL_EV_SK3, 
           CAR.AVANTE_HEV_CN7, CAR.SANTAFE_HEV_TM, CAR.K5_DL3, CAR.K5_HEV_DL3, CAR.SOUL_SK3],
...
FEATURES = {
  ...
  "use_tcu_gears": {CAR.K5_JF, CAR.SONATA_LF, CAR.VELOSTER_JS, CAR.SONATA_TURBO_LF, CAR.SPORTAGE_QL, CAR.TUCSON_TL},
  # Use E_GEAR Message for Gear Selection
  "use_elect_gears": {CAR.SONATA_HEV_DN8, CAR.SONATA_HEV_LF, CAR.KONA_EV_OS, CAR.KONA_HEV_OS, CAR.IONIQ_EV_AE, CAR.IONIQ_EV_AE_2020, CAR.IONIQ_HEV_AE, CAR.GRANDEUR_HEV_IG, 
  ...
  "send_lfahda_mfa": {CAR.GRANDEUR_HEV_FL_IG, CAR.GRANDEUR_FL_IG, CAR.SONATA_DN8, CAR.PALISADE_LX2, CAR.SONATA_HEV_DN8, CAR.SANTAFE_TM, CAR.KONA_EV_OS, 
                      ...
                      CAR.K7_YG_2020, CAR.NIRO_HEV_DE_2021, CAR.K9_RJ, CAR.CASPER, CAR.STINGER_2022, CAR.MORNING, CAR.IONIQ_EV_AE_2020, CAR.NIRO_PLUS_EV_DE},
...
EV_CAR = {CAR.IONIQ_EV_AE, CAR.KONA_EV_OS, CAR.NIRO_EV_DE, CAR.NEXO_FE, CAR.SOUL_EV_SK3, CAR.NIRO_PLUS_EV_DE, CAR.IONIQ_EV_AE_2020}
...
if Params().get_bool("UseRadarTrack"):
  DBC = {
    ...
    CAR.IONIQ_EV_AE_2020: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
    ...
    CAR.SOUL_SK3: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  }
else:
  DBC = {
    # genesis
    ...
    CAR.IONIQ_EV_AE_2020: dbc_dict('hyundai_kia_generic', None),
    ...
    CAR.SOUL_SK3: dbc_dict('hyundai_kia_generic', None),
