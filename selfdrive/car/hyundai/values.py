...
FEATURES = {
  ...
  "use_cluster_gears": {CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KONA,  CAR.K7},
...
DBC = {
  ...
  CAR.KIA_K7_2020: dbc_dict('hyundai_kia_generic', None),
